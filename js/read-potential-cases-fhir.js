...
(async () => {
  ...
  await fs.writeFile("protein-kinase-inhibitor-medication-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("protein-kinase-inhibitor-medication-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
